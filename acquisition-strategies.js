(function initAcquisitionStrategies(root, factory) {
  ...
  const STRATEGIES = Object.freeze({
    ...
    high_ticket: Object.freeze({ id: "high_ticket", name: "High Ticket", active: true, runnable: false, serviceId: null, questEligible: false, assignmentMode: "human_only", defaultMinimumScore: null, requiredHumanReview: "strict", allowedChannels: Object.freeze([]), researchProfile: "not_configured", qualificationProfile: "not_configured", messagePolicy: "not_configured", createdAt: "2026-09-12", updatedAt: "2026-09-12" }),
  });
